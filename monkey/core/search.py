...
def index_entity(instance, index, only=None, exclude=None, extra_converters=None, indexer=None, callback=None):
    ...
    This is usually done in :meth:`Model.after_put <monkey.core.ndb.Model.after_put>`, for example::
...
def unindex_entity(instance_or_key, index=None):
    ...
    This is usually done in :meth:`Model.after_delete <monkey.core.ndb.Model.after_delete>`, for example::
