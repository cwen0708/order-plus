...
"""
from monkey.core.wtforms.wtforms import Form, validators, fields as f
from monkey.core.wtforms.wtforms.compat import string_types
from monkey.core.wtforms.wtforms.ext.appengine.fields import GeoPtPropertyField, KeyPropertyField, StringListPropertyField, IntegerListPropertyField
...
class ModelConverter(ModelConverterBase):
    ...
    def convert_DateTimeProperty(self, model, prop, kwargs):
        ...
        if prop._auto_now or prop._auto_now_add:
            if prop._code_name == 'created' or prop._code_name == 'modified':
                return None
