...
from monkey.core.wtforms.wtforms.compat import with_metaclass, iteritems, itervalues
from monkey.core.wtforms.wtforms.meta import DefaultMeta
...
class FormMeta(type):
    ...
    def __call__(cls, *args, **kwargs):
        ...
        if cls._wtforms_meta is None:
            ...
            cls._wtforms_meta.locales = ['zh_TW']
