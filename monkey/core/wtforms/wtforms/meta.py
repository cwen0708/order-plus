from monkey.core.wtforms.wtforms.utils import WebobInputWrapper
from monkey.core.wtforms.wtforms import i18n
...
class DefaultMeta(object):
    ...
    def build_csrf(self, form):
        ...
        from monkey.core.wtforms.wtforms.csrf.session import SessionCSRF
        return SessionCSRF()
