...
def get_instance(application_path=None):
    ...
    from monkey.core import plugins
    s = get_setting()

    appstats_settings = s['appstats']
    plugins_settings = s['plugins']
    ...
    from monkey.core import errors
    ...
    routing.auto_route(_instance.router, s['plugins'], application_path, debug)
