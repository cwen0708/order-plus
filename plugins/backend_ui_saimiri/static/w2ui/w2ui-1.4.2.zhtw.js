...
var w2utils = (function () {
    ...
    var obj = {
        ...
        settings : {
            ...
            "dataType"          : 'RESTFULL',   // can be HTTP, RESTFULL, JSON (case sensative)
             "phrases": {
                ...
                "selected": "個選擇的項目",
                "none": "没有",
                "Type to search....": "輸入字串來搜尋....",
                "No matches": "沒有相符的項目",
                "Loading...": "正在載入...",
                "No items found": "没有找到項目",
                "Attach files by dragging and dropping or Click to Select": "點此上傳檔案，或將檔案拖拉至此處",
                "Remove": "移除",
                "Not a valid date": "不是一個有效的日期",
                "Required field": "必需填寫",
                "Saving...": "儲存中...",
                "Not an integer": "不是一個整數(int)",
                "Not a float": "不是一個浮點數(float)",
                "Not in money format": "不是貨幣格式",
                "Not a hex number": "不是一個十六進制數",
                "Not alpha-numeric": "不是字母或數字",
                "AJAX error. See console for more details.": "讀取時發生錯誤，檢視控制台來了解更多細節",
                "Not a valid email": "不是一個有效的Email地址",
                "Are you sure you want to delete selected records?": "你是想要刪除選中的記錄嗎?",
                ...
                "Yes": "是",
                "No": "不是",
                "Reload data in the list": "重新加載資料列表中",
    ...
    w2field.prototype = {
        ...
        change: function (event) {
            ...
            if (['date', 'time'].indexOf(this.type) != -1) {
                ...
                if (w2utils.isInt(tmp) && tmp > 1000 && obj.el.value.indexOf("/") != -1 && obj.el.value.indexOf("-") != -1) {
